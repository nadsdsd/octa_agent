...
_event_queue_var: contextvars.ContextVar[Optional[asyncio.Queue]] = contextvars.ContextVar(
    "stream_event_queue", default=None
)
...
def set_stream_event_queue(queue: Optional[asyncio.Queue]):
    return _event_queue_var.set(queue)


def reset_stream_event_queue(token) -> None:
